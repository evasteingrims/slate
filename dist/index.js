...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (hasDomSelection && newDomRange && (isRangeEqual(domSelection.getRangeAt(0), newDomRange) || selection && !slate.Range.isCollapsed(selection) && !domSelection.getRangeAt(0).collapsed)) {
      return;
