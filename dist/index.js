...
var ReactEditor = {
  ...
  hasDOMNode(editor, target) {
    ...
    return targetEl.closest("[data-slate-editor]") === editorEl && (!editable || targetEl.isContentEditable || targetEl.hasAttribute('data-slate-void') || !!targetEl.getAttribute('data-slate-zero-width'));
  },
