...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (hasDomSelection && newDomRange && (isRangeEqual(domSelection.getRangeAt(0), newDomRange) || selection && !Range.isCollapsed(selection) && !domSelection.getRangeAt(0).collapsed)) {
      return;
    ...
    if (newDomRange) {
      ...
      if (selection && Range.isCollapsed(selection) && leafEl.hasAttribute('data-slate-zero-width') && leafEl.getAttribute('data-slate-zero-width') !== 'z') {
